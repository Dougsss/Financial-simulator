...
export default function Simulator({ indicators }) {
  ...
  return (
    <div className="flex flex-col mt-8 lg:flex-row">
      <form className="flex flex-col w-1/2" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex flex-row gap-12">
          <div className="flex flex-col">
            ...
            <div className="flex flex-row mb-6 border-2 border-black rounded-lg">
            ...
            <input className="border-b-2 border-gray-400 appearance-none" autoComplete="off" type="text" {...register("deadLine", { required: true, min: 1 })} />
            ...
            <input className="mb-8 border-b-2 border-gray-400 appearance-none" autoComplete="off" type="text" {...register("ipca", { disabled: true })} />
          ...
          <div className="flex flex-col">
            ...
            <input className="border-b-2 border-gray-400 appearance-none" autoComplete="off" type="number" {...register("profitability", { required: true, min: 0 })} />
            ...
            <input className="mb-8 border-b-2 border-gray-400 appearance-none" autoComplete="off" type="text" {...register("cdi", { disabled: true })} />
      ...
      <div className="flex flex-col w-1/2 mt-12 lg:flex-row gap-x-5">
        <div className="flex flex-col gap-y-5">
          <div className="p-5 bg-white">Valor final bruto
            <p>{result?.valorFinalBruto}</p></div>
          <div className="p-5 bg-white">Valor final líquido
